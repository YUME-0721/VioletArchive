...
export const siteConfig: SiteConfig = {
	title: "VioletArchive",
	subtitle: "紫罗兰手札",
	siteURL: "https://violetarchive.2780666.xyz/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1015457", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	banner: {
		...
		imageApi: {
			enable: true, // 启用图片API
			url: "https://pixport.072199.xyz/image_api.php?format=text", // API地址，返回每行一个图片链接的文本
		},
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://ume666-twikoo.hf.space",
...
export const footerConfig: FooterConfig = {
	...
	customHtml:
		"<div style='display: flex; flex-direction: column; align-items: center; gap: 8px;'><p style='margin: 0; font-size: 14px; color: var(--text-primary);'>@YUME &copy; 2025-2026</p><p style='margin: 0; font-size: 13px; color: var(--text-secondary); font-style: italic;'>「代码是理性的诗，这里是诗的草稿」</p><p style='margin: 0; font-size: 12px; color: var(--text-tertiary);'>改编基于 <a href='https://astro.build' target='_blank' style='color: var(--primary); text-decoration: none;'>Astro</a> 框架 & <a href='https://github.com/matsuzaka-yuki/mizuki' target='_blank' style='color: var(--primary); text-decoration: none;'>Mizuki</a> 主题</p></div>", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_srrOAqbswkHiepqfRAYAwbO3GXMDy3Z6", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="a27b4676-fb05-4dd4-926f-1f2f77aaf843"></script>
